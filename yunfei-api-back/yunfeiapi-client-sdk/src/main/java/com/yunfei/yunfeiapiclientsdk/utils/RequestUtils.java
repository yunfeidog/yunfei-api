...
public class RequestUtils {
     ...
     * @param params  params
     * @return {@link String}
     * @throws GlobalApiException api异常
     */
    public static <T> String buildUrl(String baseUrl, T params) throws GlobalApiException {
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                throw new GlobalApiException(ErrorCode.OPERATION_ERROR, "构建url异常");
            }
        }
        return url.toString();
    }
     ...
     * @throws GlobalApiException api异常
     */
    public static <T> String get(String baseUrl, T params) throws GlobalApiException {
